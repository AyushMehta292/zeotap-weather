...
const RuleEngine = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-200 py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="p-6">
            {isLoading ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-2 px-4 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition duration-300 ease-in-out transform hover:scale-105"
                  disabled={isLoading}
                >
                  Create Rule
                </button>
                ...
                >
                  <div>
                    ...
                    <select
                      ...
                      className="block w-full rounded-md border-gray-600 border shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    >
