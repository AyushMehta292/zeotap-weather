...
const RulesList = ({ savedRules, setSavedRules }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gradient-to-br from-gray-100 to-blue-200 shadow-lg rounded-lg">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-indigo-700">Saved Rules</h1>
        <button
          onClick={handleCombineRules}
          disabled={selectedRules.length < 2}
          className={`bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition duration-300 ease-in-out transform hover:scale-105 ${
      ...
      {savedRules.length === 0 ? (
        ...
        <div className="overflow-auto">
          <table className="w-full border-collapse border border-gray-300 min-w-[800px] shadow-md rounded-lg">
            <thead>
                  ...
                  <td className="border border-gray-300 px-4 py-2">
                    {editingRuleId === rule._id ? (
                      <button
                        ...
                        disabled={isUpdating}
                        className={`bg-green-500 text-white px-2 py-1 rounded-md hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105 ${
                      ...
                      <button
                        ...
                        className="bg-blue-500 text-white px-2 py-1 rounded-md hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 mr-2"
                      >
                        Edit
                      </button>
                    )}
                    <button
                      ...
                      className={`bg-red-500 text-white px-2 py-1 rounded-md hover:bg-red-600 transition duration-300 ease-in-out transform hover:scale-105 ${
                        isDeleting === rule._id
